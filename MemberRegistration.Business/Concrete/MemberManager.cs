...
namespace MemberRegistration.Business.Concrete
{
    public class MemberManager : IMemberService
    {
        ...
        private void CheckIfUserValidFromKps(Member member)//kullanıcı bilgileri kpsService'e uymuyorsa
        {
        ...
        private void CheckIfMemberExists(Member member)//kullanıcı zaten varsa
        {
